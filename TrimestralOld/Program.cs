                ...
                switch (op)
                {
                    ...
                    case 6:
                        ...
                        if (rest.Mesa[a].Reservado)
                        {
                            ...
                            rest.Mesa[a].AnotarPedido(pedido, valor);
                        }
                        else
                        {
                    ...
                    case 7:
                        ...
                        {
                            Console.WriteLine("Mesa reservada corretamente\n");
                            rest.Mesa[b].Comanda.ListarConsumo();
                        }
                        else
                        {
                    ...
                    case 8:
                        ...
                        if (rest.Mesa[c].Reservado)
                        {
                            ...
                            double dezPorcento = rest.Mesa[c].Comanda.Calcular10Porcento();

                            Console.WriteLine($"Os 10% da mesa {c} é R${dezPorcento.ToString("0.00")} ");
                    ...
                    case 9:
                        ...
                        if (rest.Mesa[d].Reservado)
                        {
                            ...
                            double valor = rest.Mesa[d].Comanda.DividirConta(numClientes);
                            

                            Console.WriteLine($"O valor a pagar por cada cliente: R${valor.ToString("0.00")}");
                        }
                        else
                        {
